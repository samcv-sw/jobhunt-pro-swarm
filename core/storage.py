...
def get_s3_client():
    ...
    if not all([R2_ACCOUNT_ID, R2_ACCESS_KEY_ID, R2_SECRET_ACCESS_KEY]):
        logger.warning("Cloudflare R2 credentials not fully configured. Storage features may be degraded.")
        return None
...
class StorageManager:
    ...
    def upload_file(self, file_content: bytes, object_name: str, content_type: str = 'application/pdf') -> str:
        """
