...
TEXT_COMMAND_MAP = {
    ...
    "🖥️ Status": "/status", "الحالة": "/status",

    "📊 Stats": "/stats", "الإحصائيات": "/stats",

    "📈 Today Report": "/stats today", "تقرير اليوم": "/stats today",

    "📅 Weekly Report": "/stats week", "أسبوعي": "/stats week",

    "🗓️ Monthly Report": "/stats month", "شهري": "/stats month",
    ...
    "📊 Provider Health": "/status", "صحة المزودين": "/status",

    "⚡ Speed Test": "/speed_test", "اختبار السرعة": "/speed_test",

    # System Info

    "🗂️ Queue": "/queue", "الطابور": "/queue",

    "📜 Logs": "/logs", "السجلات": "/logs",

    "🌡️ Memory": "/memory", "الذاكرة": "/memory",

    "⏱️ Uptime": "/uptime", "وقت التشغيل": "/uptime",

    "🧠 AI Status": "/ai_check", "حالة الذكاء": "/ai_check",

    "📬 Inbox Check": "/inbox_check", "فحص الردود": "/inbox_check",

    "🔔 Notify Me": "/inbox_check", "أخبرني": "/inbox_check",

    "📡 Ping Render": "/status", "اختبار الخادم": "/status",

    "🔑 Env Check": "/env_check", "فحص المتغيرات": "/env_check",

    "🌐 Platforms": "/platforms", "المواقع": "/platforms",
    ...
    "🛰️ Track": "/track", "التتبع المباشر": "/track",

    "📊 Top Companies": "/top_companies", "أفضل شركات": "/top_companies",

    "🌍 Countries": "/countries", "الدول": "/countries",

    "💼 Job Titles": "/job_titles", "المسميات": "/job_titles",

    "🔮 Oracle": "/oracle", "أوراكل السوق": "/oracle",

    "📊 Campaign": "/campaign", "الحملة": "/campaign",

    "📨 Follow-ups": "/followups", "متابعات": "/followups",

    # Actions

    "🌍 Scrape Now": "/search", "اسكان فوري": "/search",
    ...
    "⛔ Blacklist": "/blacklist", "القائمة السوداء": "/blacklist",

    "🚀 Run Now": "/campaign", "شغّل": "/campaign",

    "🔧 Fix": "/fix", "إصلاح": "/fix",

    # Controls

    "⏸️ Pause": "/pause", "إيقاف مؤقت": "/pause",

    "▶️ Resume": "/resume", "استئناف": "/resume",

    "🌙 Night Mode": "/night_mode", "وضع الليل": "/night_mode",

    "🧪 Dry Run": "/dry_run", "تجربة آمنة": "/dry_run",

    "🛑 Omega Halt": "/omega_halt", "التوقف التام": "/omega_halt",

    "💀 Kill Switch": "/kill_switch", "إيقاف كامل": "/kill_switch",

    "📖 Guide": "/guide", "الدليل": "/guide",
    ...
    "✏️ Set Key": "/set_key", "تغيير مفتاح": "/set_key",

    "🧪 Test Key": "/test_key", "اختبار مفتاح": "/test_key",

    "🔑 Env": "/env", "المتغيرات": "/env",

    "📡 Ping": "/status", "اختبار الخادم": "/status",
    ...
    "✉️ Cover Letter": "/cover_letter", "رسالة التغطية": "/cover_letter",

    "📧 Test Email": "/test_email", "تجربة إيميل": "/test_email",

    "🧪 Test Strike": "/test_strike", "تجربة ضربة": "/test_strike",

    "🔔 Notify": "/inbox_check", "الإشعارات": "/inbox_check",

    "📬 Inbox": "/inbox_check", "فحص الردود": "/inbox_check",

    "🔁 Retry": "/retry_failed", "إعادة": "/retry_failed",

    # System

    "🛡️ Shield": "/shield", "الدرع": "/shield",
    ...
    "🧹 Clean Disk": "/clean", "تنظيف": "/clean",

    "🧹 Clean": "/clean", "تنظيف الذاكرة": "/clean",

    "💾 Backup": "/backup", "نسخة احتياطية": "/backup",

    "🔄 Reboot": "/reboot", "إعادة تشغيل": "/reboot",

    "⚙️ Settings": "/settings", "الإعدادات": "/settings",

    "🗑️ Clear Queue": "/clear_queue", "مسح الطابور": "/clear_queue",

    "🔥 Boost Mode": "/boost", "وضع تسريع": "/boost",

    "🔥 Boost": "/boost", "تسريع": "/boost",

    # Variants

    "🛰️ Track": "/track", "التتبع": "/track",

    "📊 Campaign": "/campaign", "الحملة": "/campaign",

    "🌙 Night": "/night_mode", "الليل": "/night_mode",

    "🧪 Dry Run": "/dry_run", "آمنة": "/dry_run",

    "⏸️ Pause": "/pause", "وقف": "/pause",

    "▶️ Resume": "/resume", "كمّل": "/resume",

    "🔄 Reboot": "/reboot", "إعادة": "/reboot",

    "🌍 Countries": "/countries", "الدول المستهدفة": "/countries",

    "💼 Job Titles": "/job_titles", "المسميات الوظيفية": "/job_titles",
    ...
    "⛔ Blacklist": "/blacklist", "السوداء": "/blacklist",

    "🎪 Mass Strike": "/mass_strike", "جماعية": "/mass_strike",

    "🎯 Force Strike": "/force_strike", "فورية": "/force_strike",
    ...
    "📈 Trend": "/trend", "الاتجاهات": "/trend",
    "📊 Funnel": "/funnel", "المسار التحويل": "/funnel",
    "✨ Features": "/features", "الميزات": "/features",
...
class TelegramBot:
    ...
    def __init__(self):
        ...
        self.http_client = httpx.AsyncClient(
            timeout=10,
            limits=Limits(max_keepalive_connections=2, max_connections=4)
        )
        ...
        self._cmd_category_map = {
            # 🎯 Applications
            "/start": "Applications", "/campaign": "Applications", "/search": "Applications",
            "/apply": "Applications", "/test_strike": "Applications",
            "/force_strike": "Applications", "/mass_strike": "Applications",
            "/wallet": "Applications", "/balance": "Applications",
            "/pricing": "Applications", "/referral": "Applications",
            "/whatsapp": "Applications", "/strategy": "Applications",
            "/earnings": "Applications", "/contact": "Applications",
            # 📊 Analytics
            "/status": "Analytics", "/stats": "Analytics", "/sales": "Analytics",
            "/applications": "Analytics", "/campaigns": "Analytics",
            "/stats_overview": "Analytics", "/pulse": "Analytics",
            "/today": "Analytics", "/weekly": "Analytics",
            "/best_day": "Analytics", "/email_stats": "Analytics",
            "/failure_rate": "Analytics", "/speed_test": "Analytics",
            "/memory": "Analytics", "/uptime": "Analytics",
            "/audit": "Analytics", "/queue": "Analytics",
            "/top_companies": "Analytics", "/countries": "Analytics",
            "/job_titles": "Analytics", "/platforms": "Analytics",
            "/tasks": "Analytics", "/inbox_check": "Analytics",
            "/leads": "Analytics", "/companies": "Analytics",
            "/trend": "Analytics", "/funnel": "Analytics",
            # ⚙️ Settings
            "/settings": "Settings", "/pause": "Settings", "/resume": "Settings",
            "/night_mode": "Settings", "/dry_run": "Settings",
            "/omega_halt": "Settings", "/kill_switch": "Settings",
            "/boost": "Settings", "/clear_queue": "Settings",
            "/stop": "Settings", "/env_check": "Settings",
            # 🛠️ Tools
            "/help": "Tools", "/guide": "Tools",
            "/fix": "Tools", "/clean": "Tools",
            "/backup": "Tools", "/reboot": "Tools",
            "/logs": "Tools", "/deploy": "Tools",
            "/security": "Tools", "/ats_score": "Tools",
            "/ats": "Tools", "/converse": "Tools",
            "/followups": "Tools", "/shield": "Tools",
            "/blacklist": "Tools", "/oracle": "Tools",
            "/track": "Tools", "/skip_lead": "Tools",
            "/pin_lead": "Tools", "/retry_failed": "Tools",
            "/find_emails": "Tools", "/synapse": "Tools",
            "/websites": "Tools", "/restart_web": "Tools",
            "/chat": "Tools", "/prep": "Tools",
            "/cv_preview": "Tools", "/cover_letter": "Tools",
            "/test_email": "Tools", "/test_key": "Tools",
            "/set_key": "Tools", "/keys": "Tools",
            "/ai_check": "Tools", "/features": "Tools",
            # 🔧 Admin
            "/admin": "Admin", "/admin_credit": "Admin",
            "/generate_code": "Admin", "/flash_sale": "Admin",
        }
        ...
        self.notifier = TelegramNotifier(
            ...
            send_callback=self._send_notification
        )
    ...
    async def send(self, message, parse_mode="HTML", reply_markup=None, retries=2):
        ...
        if last_error:
            logger.error(f"[BOT] send() all {retries+1} attempts failed: {last_error}")
    ...
    async def send_with_keyboard(self, message, buttons, parse_mode="HTML"):
        ...
        logger.info(f"[BOT] send_with_keyboard: msg={str(message)[:60] if message else 'empty'}")
    ...
    def _get_nav_keyboard(self, current_page: str = "main"):
        ...
        keyboards = {
            "main": [
                ...
                [{"text": "📊 Dashboard", "web_app": {"url": "https://jhfguf.pythonanywhere.com/webapp/"}}],
    ...
    async def send_with_reply_keyboard(self, message, parse_mode="HTML"):
        ...
        logger.info(f"[BOT] send_with_reply_keyboard: msg={str(message)[:60] if message else 'empty'}")
    ...
    async def _check_rate_limit(self, user_id: int, max_per_minute: int = 5) -> bool:
        ...
        # Clean old entries
        self._user_rate_limits = {k: v for k, v in self._user_rate_limits.items() if now - v["window_start"] < window}
        ...
        if entry["count"] > max_per_minute:
            logger.warning(f"[BOT] Rate limit hit for user {user_id}: {entry['count']} req/min")
            return False
        return True
        ...
        for attempt in range(3):
            try:
                ...
                if attempt < 2:
                    ...
                    logger.warning(f"Telegram callback answer failed after 3 attempts: {e}")
    async def send_photo(self, photo_path, caption=""):
        ...
        try:
            ...
            await self.http_client.post(url, data={
                "chat_id": self.chat_id,
                "caption": caption,
                "parse_mode": "HTML"
    ...
    async def get_updates(self, offset=0):
        ...
        for attempt in range(max_retries):
            try:
                params = {"offset": offset, "timeout": 0} if offset is not None else {"timeout": 0}
                resp = await self.http_client.get(url, params=params, timeout=4)
                if resp.status_code == 409:
                    logger.warning(f"[BOT] getUpdates 409 Conflict - another poller is active")
                    return ([], True)
                if resp.status_code in (429, 502, 503, 504):
                    backoff = min(30, 2 ** (attempt + 1))
                    logger.warning(f"[BOT] getUpdates {resp.status_code} (attempt {attempt+1}/{max_retries}), backoff {backoff}s")
                ...
                if attempt < max_retries - 1:
                    ...
                    logger.warning(f"[BOT] getUpdates error (attempt {attempt+1}/{max_retries}): {e}, retry in {backoff}s")
                    await asyncio.sleep(backoff)
                else:
                    logger.error(f"[BOT] getUpdates failed after {max_retries} attempts: {e}")
                    return ([], False)
    ...
    async def cmd_help(self, args=""):
        ...
        for cmd in sorted(self.commands.keys()):
            ...
            formatted = f"<code>{cmd}</code> — {desc}" if desc else f"<code>{cmd}</code>"
            if cat in categories:
                categories[cat].append(formatted)
            else:
                # Map plain category names to emoji keys
                emoji_cat = {"Applications": "🎯 Applications", "Analytics": "📊 Analytics", 
                             "Settings": "⚙️ Settings", "Tools": "🛠️ Tools", "Admin": "🔧 Admin"}.get(cat)
        ...
        if uncategorized:
            ...
            for c in uncategorized:
                lines.append(c)
        lines.append("")
        lines.append("<i>💡 Use /features to explore all capabilities • Made with ❤️ by Sam Salameh | JobHunt Pro v16.88</i>")
        msg = "\n".join(lines)
    ...
    async def cmd_status(self, args=""):
        ...
        try:
            ...
            health_icon = "🟢" if health_score >= 70 else "🟡" if health_score >= 40 else "🔴"
    ...
    async def cmd_applications(self, args=""):
        ...
        try:
            ...
            for i, app in enumerate(apps, 1):
                ...
                sent_str = a.get('applied_at', '')[:10] if a.get('applied_at') else 'N/A'
    ...
    async def cmd_wallet(self, args=""):
        ...
        btc = (config.CRYPTO_BTC_ADDRESS if hasattr(config, 'CRYPTO_BTC_ADDRESS')

               and config.CRYPTO_BTC_ADDRESS else "Not configured")

        eth = (config.CRYPTO_ETH_ADDRESS if hasattr(config, 'CRYPTO_ETH_ADDRESS')

               and config.CRYPTO_ETH_ADDRESS else "Not configured")

        usdt = (config.CRYPTO_USDT_ADDRESS if hasattr(config, 'CRYPTO_USDT_ADDRESS')

                and config.CRYPTO_USDT_ADDRESS else "Not configured")

        ltc = (config.CRYPTO_LTC_ADDRESS if hasattr(config, 'CRYPTO_LTC_ADDRESS')

               and config.CRYPTO_LTC_ADDRESS else "Not configured")
    ...
    async def cmd_balance(self, args=""):
        ...
        try:
            ...
            user = conn.execute(
                ...
                "SELECT wallet_balance FROM users LIMIT 1"
    ...
    async def cmd_test_strike(self, args=""):
        ...
        await self.send("<b>🧪 TEST STRIKE | تجربة</b>\n\n🔍 Running test application...")
        conn = None
        try:
            conn = _get_db()
            stats = {
                "total_jobs": conn.execute("SELECT COUNT(*) FROM jobs").fetchone()[0],
                "total_applied": conn.execute("SELECT COUNT(*) FROM jobs WHERE applied_at IS NOT NULL").fetchone()[0],
            ...
            if groq_key[:4] == "gsk_":
                try:
                    r = await self.http_client.post(
                        ...
                        json={"model": "mixtral-8x7b-32768", "messages": [{"role": "user", "content": "ping"}], "max_tokens": 1},
            ...
            msg = ("<b>🧪 TEST STRIKE — Issue Detected</b>\n\n"
    ...
    async def cmd_ai_check(self, args=""):
        ...
        # Check JSearch
        jsearch_key = getattr(config, 'JSEARCH_API_KEY', '') or os.environ.get('JSEARCH_API_KEY', '')
        if jsearch_key:
        ...
        try:
            ...
            results.append(f"{'🟢' if pa_status == 'ok' else '🟡'} PA Server — {pa_status}")
        except Exception as e:
    ...
    async def cmd_keys(self, args=""):
        ...
        import os
        key_map = {
            "GROQ_API_KEY": ("Groq API", lambda k: k.startswith("gsk_") if k else False),
        ...
        smtp_user = getattr(config, 'SMTP_USER', None) or os.environ.get('SMTP_USER', '')
    ...
    async def cmd_fix(self, args=""):
        ...
        await self.send("<b>🔧 AI DIAGNOSTICS | تشخيص ذكي</b>\n\n🔍 Analyzing system... Please wait.")
        try:
    ...
    async def cmd_restart_web(self, args=""):
        ...
        valid = {"pythonanywhere": "PythonAnywhere", "pa": "PythonAnywhere", "render": "Render"}
        if platform not in valid:
            await self.send(f"❌ Unknown platform. Use: /restart_web pythonanywhere OR /restart_web render")
            return
    ...
    async def cmd_inbox_check(self, args=""):
        ...
        try:
            conn = _get_db()
            responded = conn.execute("SELECT COUNT(*) as c FROM jobs WHERE responded_at IS NOT NULL").fetchone()["c"]
            recent = conn.execute(
    ...
    async def cmd_force_strike(self, args=""):
        ...
        await self.send("<b>🎯 FORCE STRIKE | ضربة فورية</b>\n\n⚡ Triggering immediate application run...")
        async with self._state_lock:
            self._auto_running = True
        try:
            ...
            plat_info = "\n".join([f"  • {p}: {len(j)} jobs" for p, j in results.items()])
            msg = (
    ...
    async def cmd_mass_strike(self, args=""):
        ...
        await self.send("<b>🎪 MASS STRIKE | ضربة جماعية</b>\n\n🌍 Launching mass strike across ALL platforms...")
        async with self._state_lock:
            self._auto_running = True
        try:
            from core.multi_platform_apply import AutoApplyOrchestrator
            ...
            titles = ["network engineer", "it manager", "infrastructure engineer", "devops engineer", "system administrator"]
            locations = ["Dubai", "Remote", "Abu Dhabi", "Riyadh", "Doha"]
            total_found = 0
            all_results = {}
            for q in titles:
                for loc in locations:
                    results = await orch.search_all(query=q, location=loc, max_per_platform=2)
                    for k, v in results.items():
                        all_results.setdefault(k, []).extend(v)
                        total_found += len(v)
            plat_info = "\n".join([f"  • {p}: {len(j)} jobs" for p, j in all_results.items()])
            msg = (
    ...
    async def cmd_blacklist(self, args=""):
        ...
        try:
            ...
            if self._table_exists(conn, "blacklist"):
                blacklisted = conn.execute("SELECT company, reason, created_at FROM blacklist ORDER BY created_at DESC LIMIT 20").fetchall()
    ...
    async def cmd_oracle(self, args=""):
        ...
        try:
            ...
            applied = conn.execute("SELECT COUNT(*) as c FROM jobs WHERE applied_at IS NOT NULL").fetchone()["c"]
            # Get top 5 titles
            titles = conn.execute("SELECT title, COUNT(*) as c FROM jobs WHERE title IS NOT NULL GROUP BY title ORDER BY c DESC LIMIT 5").fetchall() if self._table_exists(conn, "jobs") else []
            # Get top countries
            countries = conn.execute("SELECT company, COUNT(*) as c FROM jobs WHERE company IS NOT NULL GROUP BY company ORDER BY c DESC LIMIT 5").fetchall() if self._table_exists(conn, "jobs") else []
    ...
    async def cmd_email_stats(self, args=""):
        ...
        try:
            conn = _get_db()
            total_sent = conn.execute("SELECT COUNT(*) as c FROM campaign_emails WHERE status='sent'").fetchone()["c"] if self._table_exists(conn, "campaign_emails") else 0
            opened = conn.execute("SELECT COUNT(*) as c FROM campaign_emails WHERE opened_at IS NOT NULL").fetchone()["c"] if self._table_exists(conn, "campaign_emails") else 0
            failed = conn.execute("SELECT COUNT(*) as c FROM campaign_emails WHERE status='failed'").fetchone()["c"] if self._table_exists(conn, "campaign_emails") else 0
    ...
    async def cmd_reboot(self, args=""):
        ...
        await self.send("<b>🔄 Rebooting process...</b> Restart will trigger via watchdog.")
        try:
            os._exit(42)
        except Exception:
            pass
    ...
    async def cmd_logs(self, args=""):
        ...
        try:
            ...
            log_files = sorted(Path(log_dir).glob("*.log"), key=os.path.getmtime, reverse=True) if log_dir.exists() else []
            if log_files:
                with open(log_files[0], "r", encoding="utf-8", errors="replace") as f:
                    ...
                    await self.send(f"<b>📜 Recent Logs ({log_files[0].name})</b>\n\n<pre>{last_30}</pre>")
            else:
    ...
    async def cmd_queue(self, args=""):
        ...
        try:
            ...
            if self._table_exists(conn, "job_queue"):
                pending = conn.execute("SELECT COUNT(*) as c FROM job_queue WHERE status='pending'").fetchone()["c"]
                processing = conn.execute("SELECT COUNT(*) as c FROM job_queue WHERE status='processing'").fetchone()["c"]
            if self._table_exists(conn, "jobs"):
                completed_today = conn.execute("SELECT COUNT(*) as c FROM jobs WHERE date(applied_at) = ?", (today,)).fetchone()["c"]
            auto_status = "🟢 Running" if getattr(self, '_auto_running', False) else "⏸️ Paused"
            msg = (
                "<b>🗂️ QUEUE | الطابور</b>\n\n"
                f"📊 <b>Queue Status:</b>\n"
    ...
    async def _show_stats_compact(self, query):
        ...
        await self.send("<i>📊 Navigation:</i>", reply_markup=self._get_nav_keyboard("stats"))
    ...
    async def _show_job_details(self, query, job_id):
        ...
        try:
            ...
            row = c.fetchone()
            if not row:
                await self.answer_callback_query(query.get("id", ""), "Job not found", True)
                return
            await self.answer_callback_query(query.get("id", ""), "")
            msg = (
                f"📌 <b>{row['title']}</b>\n\n"
            ...
            await self.answer_callback_query(query.get("id", ""), "Error loading job", True)
        finally:
            if conn:
                conn.close()
    ...
    async def _apply_to_job(self, query, job_id):
        ...
        try:
            ...
            conn.execute(
                "UPDATE jobs SET applied_at = ? WHERE id = ?", (now, job_id)
            )
            conn.commit()
            msg = (
    ...
    async def inline_query(self, inline_q):
        ...
        if not query or len(query) < 2:
            await self.http_client.post(f"{self.base_url}/answerInlineQuery", json={
        ...
        try:
            ...
            for i, row in enumerate(c.fetchall()):
                ...
                results.append({
                    ...
                    "reply_markup": {
                        "inline_keyboard": [[
                            {"text": "📋 View Details", "callback_data": f"job_{row['id']}"},
                            {"text": "🚀 Apply", "callback_data": f"apply_{row['id']}"},
                        ]]
                    }
                })
        except Exception as e:
    ...
    async def handle_callback_query(self, callback):
        ...
        _hcl.info(f"CB_RECV id={str(_cb_id)[:20]} msg_id={_cb_msg_id} data={repr(_cb_data)[:60]} from={_cb_from}")
        ...
        if _cb_from and not await self._check_rate_limit(_cb_from, max_per_minute=10):
            ...
            await self.answer_callback_query(_cb_id, "⏳ Please slow down!", show_alert=False)
            return
        ...
        # Clean old entries
        self._processed_callbacks = {k:v for k,v in self._processed_callbacks.items() if now - v < 60}
        
        _hcl.info("CB_PROCESS: " + str(_cb_id)[:20] + " data=" + repr(_cb_data)[:60] + " from=" + str(_cb_from))
        ...
        callback_msg_id = msg.get("message_id")
        ...
        if handler:
            await handler("")
            await self.answer_callback_query(callback_id, "")  # Dismiss spinner, prevent double-reply
            return
        ...
        if gen_handler:
            async with self._cb_lock:
                ...
                if _dedup_key in self._recent_gen_data and now - self._recent_gen_data[_dedup_key] < 30:
                    _hcl.info(f"CB_DEDUP_DATA: {_dedup_key} - IGNORING (age={now - self._recent_gen_data[_dedup_key]:.1f}s)")
                    await self.answer_callback_query(callback_id, "")
                    return
                self._recent_gen_data[_dedup_key] = now
                # Clean old entries
                self._recent_gen_data = {k:v for k,v in self._recent_gen_data.items() if now - v < 120}
        ...
        await self.send(f"<b>⚠️ Unknown button:</b> {data}\n\nUse /start to refresh the menu.")
    ...
    async def cmd_memory(self, args=""):
        ...
        try:
            ...
            await self.send(f"<b>🌡️ System Resources</b>\n• RAM: {mem:.1f} MB\n• CPU: {cpu:.1f}%")
        except ImportError:
            await self.send("<b>🌡️ Memory:</b> psutil not installed (install with pip install psutil)")
        except Exception as e:
    ...
    async def cmd_env_check(self, args=""):
        ...
        try:
            import os
            keys = ["TELEGRAM_BOT_TOKEN", "TELEGRAM_CHAT_ID", "GROQ_API_KEY", "JSEARCH_API_KEY", 
                     "BREVO_API_KEY", "DB_PATH", "SMTP_HOST", "SMTP_PORT"]
            lines = ["<b>🔑 Environment Check:</b>", ""]
            for k in keys:
                val = os.getenv(k, "")
                status = "✅ SET" if val else "❌ MISSING"
                masked = f"{val[:8]}..." if val and len(val) > 8 else ("HIDDEN" if val else "EMPTY")
        ...
        try:
            ...
            for name, url in platforms:
                try:
                    ...
                    lines.append(f"• {name}: {'✅ ONLINE' if r.status_code == 200 else f'⚠️ HTTP {r.status_code}'}")
                except Exception:
    ...
    async def cmd_synapse(self, args=""):
        ...
        try:
            ...
            campaigns = conn.execute("SELECT COUNT(*) as c FROM campaigns").fetchone()["c"] if self._table_exists(conn, "campaigns") else 0
    ...
    async def cmd_ats_score(self, args=""):
        ...
        try:
            ...
            logger.info(f"[ATS] Running match: resume={len(resume_text)} chars, jd={len(jd_text)} chars")

            await self.send("⏳ Analyzing resume against job description... (algorithmic match)")
            ...
            await self.send(f"<b>❌ ATS Score Error:</b> {e}\n\nTry again with /ats_score help")
    ...
    async def cmd_converse(self, args=""):
        ...
        """
        try:
            from core.ai_conversation import format_conversation_for_telegram, AIConversationEngine
    ...
    def _get_resume_text(self):
        ...
        try:
            conn = _get_db()
            row = conn.execute("SELECT resume_text FROM user_profile LIMIT 1").fetchone()
    ...
    async def cmd_audit(self, args=""):
        ...
        try:
            ...
            revenue = conn.execute("SELECT COALESCE(SUM(amount_usd),0) as s FROM orders WHERE payment_status='completed'").fetchone()["s"]
            await self.send(f"<b>🔍 System Audit</b>\n• Users: {users}\n• Completed Orders: {orders}\n• Revenue: ${revenue:.2f}\n• Status: ACTIVE")
        except Exception as e:
    ...
    async def cmd_clear_queue(self, args=""):
        ...
        try:
            conn = _get_db()
            if self._table_exists(conn, "job_queue"):
                count = conn.execute("SELECT COUNT(*) as c FROM job_queue WHERE status='pending'").fetchone()["c"]
                conn.execute("DELETE FROM job_queue WHERE status='pending'")
                conn.commit()
                await self.send(f"<b>🗑️ Queue Cleared</b>\n• Removed {count} pending jobs")
            else:
    ...
    async def cmd_countries(self, args=""):
        ...
        try:
            ...
            if self._table_exists(conn, "search_config"):
                rows = conn.execute("SELECT country, COUNT(*) as c FROM search_config GROUP BY country ORDER BY c DESC").fetchall()
            if rows:
                ...
                await self.send("<b>🌍 Countries:</b> No search configs yet. Use /settings to configure.")
        except Exception as e:
    ...
    async def cmd_job_titles(self, args=""):
        ...
        try:
            ...
            rows = []
            if self._table_exists(conn, "search_config"):
                rows = conn.execute("SELECT job_title, COUNT(*) as c FROM search_config GROUP BY job_title ORDER BY c DESC").fetchall()
            if rows:
                ...
                await self.send("<b>💼 Job Titles:</b> No search configs yet. Use /settings to configure.")
        except Exception as e:
    ...
    async def cmd_failure_rate(self, args=""):
        ...
        try:
            ...
            if self._table_exists(conn, "applications"):
                ...
                failed = conn.execute("SELECT COUNT(*) as c FROM applications WHERE status LIKE '%fail%' OR status LIKE '%error%'").fetchone()["c"]
            rate = (failed / total * 100) if total > 0 else 0
            await self.send(f"<b>📉 Failure Rate</b>\n• Total Apps: {total}\n• Failed: {failed}\n• Rate: {rate:.1f}%\n• Status: {'⚠️ HIGH' if rate > 30 else '✅ NORMAL' if rate > 0 else '📊 NO DATA'}")
        except Exception as e:
    ...
    async def cmd_kill_switch(self, args=""):
        ...
        try:
            ...
            if self._table_exists(conn, "campaign_emails"):
                conn.execute("UPDATE campaign_emails SET status='cancelled' WHERE status='pending'").fetchone()
            if self._table_exists(conn, "job_queue"):
                conn.execute("DELETE FROM job_queue WHERE status='pending'")
            if self._table_exists(conn, "campaigns"):
                conn.execute("UPDATE campaigns SET status='halted' WHERE status='running' OR status='pending'")
            conn.commit()
            await self.send(
    ...
    async def cmd_omega_halt(self, args=""):
        ...
        try:
            conn = _get_db()
            if self._table_exists(conn, "campaigns"):
                conn.execute("UPDATE campaigns SET status='halted' WHERE status IN ('running','pending')")
            if self._table_exists(conn, "campaign_emails"):
                conn.execute("UPDATE campaign_emails SET status='cancelled' WHERE status='pending'")
            conn.commit()
            await self.send("<b>🛑 OMEGA HALT</b>\n\n⚠️ Emergency stop initiated.\n✅ All campaigns halted.\n✅ All pending emails cancelled.\n\nUse /resume to restart operations.")
        except Exception as e:
    ...
    async def cmd_retry_failed(self, args=""):
        ...
        try:
            ...
            count = 0
            if self._table_exists(conn, "applications"):
                count = conn.execute("SELECT COUNT(*) as c FROM applications WHERE status LIKE '%fail%' OR status LIKE '%error%'").fetchone()["c"]
            await self.send(f"<b>🔄 Retry Failed</b>\n\n• Failed applications: {count}\n\nUse /campaign to restart the auto-run and retry failed apps.")
        except Exception as e:
    ...
    async def cmd_tasks(self, args=""):
        ...
        try:
            ...
            tasks = []
            if self._table_exists(conn, "job_queue"):
                tasks = conn.execute("SELECT * FROM job_queue WHERE status='pending' LIMIT 5").fetchall()
            if tasks:
                ...
                await self.send("<b>🧬 Tasks:</b> No pending tasks. Use /search to find new jobs.")
        except Exception as e:
    ...
    async def cmd_top_companies(self, args=""):
        ...
        try:
            ...
            rows = []
            if self._table_exists(conn, "applications"):
                rows = conn.execute("SELECT company, COUNT(*) as c FROM applications GROUP BY company ORDER BY c DESC LIMIT 10").fetchall()
            if rows:
                ...
                await self.send("<b>🏆 Top Companies:</b> No applications yet. Start with /campaign!")
        except Exception as e:
    ...
    async def cmd_admin_credit(self, args=""):
        ...
        if args:
            ...
            try:
                ...
                await self.send("<b>⚠️ Invalid Value:</b> Specify a number. Example: <code>/admin_credit 50</code>")
        ...
        try:
            ...
            keyboard = {
                "inline_keyboard": [
                    ...
                    [
                        {"text": "\u270f\ufe0f Custom Value", "callback_data": "/gen_value"},
                        {"text": "\U0001f4dd Custom Code", "callback_data": "/gen_custom"}
                    ],
                    [
            ...
            resp = await self.http_client.post(f"{self.base_url}/sendMessage", json={
                "chat_id": self.chat_id,
                "text": menu_text,
                "parse_mode": "HTML",
            ...
            if resp.status_code != 200:
                ...
                logger.error(f"send inline keyboard failed: {err[:100] if err else 'unknown'}")
        except Exception as e:
    ...
    async def _create_redeem_code(self, val, custom_code=None):
        ...
        try:
            conn = _get_db()
            conn.execute("INSERT INTO redeem_codes (code, value_usd, code_type, is_used) VALUES (?, ?, 'sale', 0)", (code_val, val))
            conn.commit()
            conn.close()
            conn = None
            ...
            sync_note = " ✅ Synced to website" if pa_ok else " ⚠️ Website sync failed (code may not work on site)"
            await self.send(f"<b>Code generated:</b> <code>{code_val}</code> - ${val:.2f}{sync_note}")
        except Exception as e:
...
# === STUB HANDLERS (auto-generated) ===
    ...
    async def _handle_gen_value(self):
        ...
        msg = (
            "<b>Enter the code value in USD.</b>\n\n"
    ...
    async def _process_awaiting_input(self, text: str):
        ...
        if hasattr(self, '_awaiting_input_ts') and (now_ts - self._awaiting_input_ts) > 300:
        ...
        if self._awaiting_input.get("gen_value"):
            ...
            try:
                ...
                if val <= 0 or val > 9999:
                    await self.send("<b>Invalid amount.</b> Please enter a number between 1 and 9999.")
                    return
                await self._create_redeem_code(val)
            except ValueError:
                await self.send("<b>Invalid number.</b> Please enter a valid amount like 50 or 100.")
            return
        ...
        if self._awaiting_input.get("gen_custom_text"):
            ...
            await self.send(f"<b>Custom code text:</b> <code>{text.upper()}</code>\nNow enter the value in USD:")
            return
            ...
            while True:
                try:
                    ...
                    if is_conflict:
                        ...
                        logger.warning(f"[BOT] 409 Conflict #{conflict_count}, backoff {backoff}s")
                        await asyncio.sleep(backoff)
                        continue
                    conflict_count = 0
                    max_id = offset
                        ...
                        try:
                            ...
                            if cb:
                                ...
                                if sid and str(sid) != str(self.chat_id):
                                    await self.answer_callback_query(cb.get("id",""), "Access Denied", True)
                                    continue
                    ...
                    if updates:
                        ...
                        if stuck_count >= 300 and offset:
                            logger.warning(f"Bot stuck at offset {offset}, force-resetting to 0")
                            offset = 0
                            stuck_count = 0
                    ...
                    if poll_cycle % 60 == 0:
                        logger.error(f"Bot error in polling loop (cycle #{poll_cycle}): {e}")
                    else:
                        logger.debug(f"Bot error in polling loop (cycle #{poll_cycle}): {e}")
                    await asyncio.sleep(1.0)
        finally:
    ...
    async def cmd_flash_sale(self, args=""):
        ...
        try:
            ...
            if action == "end":
                ...
                conn.commit()
                await self.send(f"<b>⚡ FLASH SALE ENDED</b>\n\nSale #{sale_id} is now inactive.")
                return
    ...
    async def _admin_send_status(self):
        ...
        try:
            import psutil
            status_lines.append(f"RAM: {psutil.Process().memory_info().rss / 1024 / 1024:.1f} MB")
        except Exception:
    ...
    async def _admin_send_db(self):
        ...
        try:
            ...
            apps = conn.execute("SELECT COUNT(*) FROM jobs WHERE applied_at IS NOT NULL").fetchone()[0]
            msg = (
                f"DB Stats\n\n"
                f"Users: {users}\n"
                f"Jobs: {jobs}\n"
        ...
        for attempt in range(3):
            try:
                ...
                if resp.status_code == 200 and data.get("ok"):
                    logger.info(f"[BOT] Command menu set: {len(self.menu_commands)} cmds (attempt {attempt+1})")
                    return
                logger.warning(f"[BOT] setMyCommands attempt {attempt+1}: HTTP {resp.status_code}")
            except Exception as e:
    ...
    async def _daily_summary_task(self):
        ...
        while True:
            ...
            try:
                conn = _get_db()
                new_jobs = conn.execute("SELECT COUNT(*) FROM jobs WHERE date(created_at) >= ?", 
                    ((datetime.now() - timedelta(days=1)).strftime('%Y-%m-%d'),)).fetchone()[0]
