...
class EmailPersonalizer:
    ...
    def _get_relevant_skill(self, company_info: dict) -> str:
        ...
        if "sd-wan" in title or "sase" in title:
            ...
            return (
                "multi-cloud networking (AWS/Azure/GCP) and hybrid cloud architecture"
            )
            ...
            return (
                "end-to-end network solutions architecture and digital transformation"
            )
        else:
    ...
    def _get_relevant_achievement(self, company_info: dict) -> str:
        ...
        if "sd-wan" in title or "sase" in title:
            ...
            return (
                "implementing Zero Trust security for 2,000+ users across 10+ countries"
            )
        elif "cloud" in title:
    ...
    def analyze_email_quality(self, subject: str, body: str) -> dict[str, Any]:
        ...
        scores["subject_length"] = (
            100 if 40 <= subject_len <= 60 else max(0, 100 - abs(50 - subject_len) * 2)
        )
        ...
        scores["body_length"] = (
            ...
            else max(0, 100 - abs(200 - word_count) * 0.5)
        )
