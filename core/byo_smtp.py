...
def smtp_config_from_credentials(email: str, password: str, provider: str = "gmail") -> Dict[str, Any]:
...
def test_smtp_connection(email: str, password: str, provider: str = "gmail") -> Tuple[bool, str]:
    ...
    try:
        ...
        return False, "❌ Authentication failed. Need App Password (not regular password). Create one at: https://myaccount.google.com/apppasswords"
    except Exception as e:
