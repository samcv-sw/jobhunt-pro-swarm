...
SAM_COMPANIES = [
    ...
    ("Toters", "Delivery Tech", "Beirut", "careers@toters.com", "toters.comm", 85),
    (
        "NAR Technologies",
        "IT Services",
        "Metn",
    ...
    ("BBAC", "Banking", "Beirut", "hr@bbacbank.com", "bbac.com.lb", 80),
    (
...
demo_user_COMPANIES = [
    ...
    ("BBAC", "Banking", "Beirut", "hr@bbacbank.com", "bbac.com.lb", 82),
    ...
    ("Dar Al Handasah", "Engineering", "Beirut", "hr@dargroup.com", "dar.com", 85),
    ("Nestle Lebanon", "FMCG", "Beirut", "hr@nestle.com", "nestle.com", 85),
    ("Unilever Lebanon", "FMCG", "Beirut", "careers@unilever.com", "unilever.com", 85),
    ("PepsiCo Lebanon", "FMCG", "Beirut", "hr@pepsico.com", "pepsico.com", 82),
    ...
    ("EY Lebanon", "Consulting", "Beirut", "careers@ey.com", "ey.com", 92),
