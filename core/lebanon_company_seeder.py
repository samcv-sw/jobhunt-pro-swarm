...
SAM_COMPANIES = [
    ...
    ("CME Offshore", "Technology", "Beirut", "careers@cmeoffshore.com", "cmeoffshore.com", 92),
    ...
    ("Inconet Data", "IT Services", "Beirut", "info@inconet.com.lb", "inconet.com.lb", 80),
    ...
    ("NAR Technologies", "IT Services", "Metn", "info@nartechnologies.com", "nartechnologies.com", 75),
    ("Malia Group", "Technology/Conglomerate", "Beirut", "hr@maliagroup.com", "maliagroup.com", 85),
    ("Procom Lebanon", "IT Services", "Beirut", "info@procomlb.com", "procomlb.com", 75),
    ("SoftFlow", "Software", "Beirut", "hr@softflow.io", "softflow.io", 78),
    ("Netways", "Software/IT", "Beirut", "careers@netways.com", "netways.com", 82),
    ("Roadster Diner", "Restaurant Tech", "Beirut", "hr@roadsterdiner.com", "roadsterdiner.com", 72),
    ("Transmed", "Distribution", "Beirut", "hr@transmed.com", "transmed.com.lb", 75),
    ("Khatib & Alami", "Engineering", "Beirut", "hr@khatibalami.com", "khatibalami.com", 85),
    ...
    ("Societe Generale Lebanon", "Banking", "Beirut", "hr@sgbank.com", "sgbank.com", 75),
    ...
    ("Clemenceau Medical Center", "Healthcare", "Beirut", "hr@cmc.com.lb", "cmclebanon.com", 82),
    ("Hotel Dieu", "Healthcare", "Beirut", "hr@hoteldieu.com", "hoteldieu.com", 80),
    ("Bellevue Medical Center", "Healthcare", "Metn", "hr@bellevuemed.com", "bellevuemedcenter.com", 80),
    ("Mount Lebanon Hospital", "Healthcare", "Mount Lebanon", "hr@mlh.com.lb", "mlhospital.com", 78),
    ("Middle East Airlines", "Aviation", "Beirut", "hr@mea.com.lb", "mea.com.lb", 85),
    ("Phoenicia Hotel", "Hospitality", "Beirut", "hr@phoeniciabeirut.com", "phoeniciabeirut.com", 82),
    ("Four Seasons Beirut", "Hospitality", "Beirut", "hr.bey@fourseasons.com", "fourseasons.com", 80),
    ("Hilton Beirut", "Hospitality", "Beirut", "hr.beirut@hilton.com", "hilton.com", 78),
    ("Le Gray Beirut", "Hospitality", "Beirut", "hr@legraybeirut.com", "legray.com", 75),
    ...
    ("Bank of Beirut", "Banking", "Beirut", "hr@bankofbeirut.com", "bankofbeirut.com", 85),
    ("Credit Libanais", "Banking", "Beirut", "hr@creditlibanais.com", "creditlibanais.com", 85),
    ...
    ("Intercontinental Phoenicia", "Hospitality", "Beirut", "hr.beyha@ihg.com", "phoenicia.com", 80),
]
...
RITA_COMPANIES = [
    ...
    ("Chalhoub Group", "Luxury Retail", "Beirut", "hr@chalhoub.com", "chalhoubgroup.com", 90),
    ...
    ("Bank of Beirut", "Banking", "Beirut", "hr@bankofbeirut.com", "bankofbeirut.com", 90),
    ("Credit Libanais", "Banking", "Beirut", "hr@creditlibanais.com", "creditlibanais.com", 88),
    ...
    ("Fattal Group", "Distribution", "Beirut", "careers@fattal.com.lb", "fattal.com.lb", 82),
    ("Kettaneh Group", "Automotive", "Beirut", "hr@kettaneh.com", "kettanehgroup.com", 80),
    ("Khatib & Alami", "Engineering", "Beirut", "hr@khatibalami.com", "khatibalami.com", 85),
    ("Dar Al Handasah", "Engineering", "Beirut", "hr@dargroup.com", "dar.com", 85),
    ...
    ("Deloitte Lebanon", "Consulting", "Beirut", "careers@deloitte.com", "deloitte.com", 92),
    ...
    ("Clemenceau Medical Center", "Healthcare", "Beirut", "hr@cmc.com.lb", "cmclebanon.com", 85),
    ("Hotel Dieu de France", "Healthcare", "Beirut", "rh@hdf-lb.org", "hoteldieu.com", 82),
    ("Bellevue Medical Center", "Healthcare", "Metn", "hr@bellevuemed.com", "bellevuemedcenter.com", 82),
    ("Mount Lebanon Hospital", "Healthcare", "Mount Lebanon", "hr@mlh.com.lb", "mlhospital.com", 80),
    ("Middle East Airlines", "Aviation", "Beirut", "hr@mea.com.lb", "mea.com.lb", 90),
    ("Phoenicia Hotel", "Hospitality", "Beirut", "hr@phoeniciabeirut.com", "phoeniciabeirut.com", 85),
    ("Four Seasons Beirut", "Hospitality", "Beirut", "hr.bey@fourseasons.com", "fourseasons.com", 82),
    ("Hilton Beirut", "Hospitality", "Beirut", "hr.beirut@hilton.com", "hilton.com", 82),
    ...
    ("Malia Group", "Conglomerate", "Beirut", "hr@maliagroup.com", "maliagroup.com", 85),
