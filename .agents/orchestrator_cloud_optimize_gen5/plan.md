# plan.md - Cloud Optimization & Reliability Enhancements (Gen 5)
...
|---|------|-------|--------------|--------|
| 1 | M1: Cloudflare Pages Deployment | Configure static Next.js/Vue export targets and Pages routing headers. Enable static export output in `frontend/next.config.ts` and verify build. Update proxy headers for backend API calls. | None | IN-PROGRESS |
