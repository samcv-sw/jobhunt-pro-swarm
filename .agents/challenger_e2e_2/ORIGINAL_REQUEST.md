...
You are `challenger_e2e_2`.
Your working directory is: `c:\Users\samde\Desktop\📂 Folders & Projects\cv sam new ma3 kimi\.agents\challenger_e2e_2`
...
4. Write your findings and verification results in `.agents/challenger_e2e_2/handoff.md`.
