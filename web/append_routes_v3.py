...
def pricing_v3(request: Request):
    ...
    pricing = {"tiers": tiers, "services": services_list}
...
def register_v2(request: Request):
...
def checkout_v3(request: Request):
...
def upload_cv_v3(request: Request):
