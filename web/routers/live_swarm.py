...
async def live_swarm_feed():
    ...
    async def event_generator():
        steps = [
            {"step": 1, "action": "Scanning target job boards (LinkedIn, Indeed, GulfTalent)...", "progress": 20, "timestamp": "now"},
            {"step": 2, "action": "Extracted 15 matching high-scoring positions.", "progress": 40, "timestamp": "now"},
            {"step": 3, "action": "Running ATS Keyword Tailoring & Cover Letter Generation...", "progress": 70, "timestamp": "now"},
            {"step": 4, "action": "Auto-applying via Stealth Scraper Engine...", "progress": 90, "timestamp": "now"},
            {"step": 5, "action": "Swarm loop completed successfully! 3 applications dispatched.", "progress": 100, "timestamp": "now"}
        ]
        for step in steps:
