...
files_to_upload = [
    'web/static/css/premium-ui.css',
    'web/templates/_public_shell.html',
    'web/templates/en/_public_shell.html',
    'web/templates/_base_tailwind.html',
    'web/templates/en/_base_tailwind.html',
    'web/templates/dashboard_v3.html',
    'web/templates/en/dashboard_v3.html',
    'web/templates/register_v2.html',
