"""Take screenshots of all key pages using Playwright"""
import subprocess, pathlib

# Take screenshots of key pages using Playwright + Chromium
script = '''
import asyncio
...
pathlib.Path(r'C:\Users\samde\Desktop\cv sam new ma3 kimi\screenshots').mkdir(exist_ok=True)

# Write and run
script_path = r'C:\Users\samde\Desktop\cv sam new ma3 kimi\_take_screenshots.py'
