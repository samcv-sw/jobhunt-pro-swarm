...
1. Uses **fallback Gmail SMTP** with configured sender email
...
server.login("admin@jobhunt-pro.com", app_password)
```
...
**Problem:**
```python
ADMIN_EMAIL = os.getenv("ADMIN_EMAIL", "admin@jobhunt-pro.com")
```
