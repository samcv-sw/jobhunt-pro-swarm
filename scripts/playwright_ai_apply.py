...
async def generate_ai_answer(question: str, pool: LLMProviderPool) -> str:
    ...
    if "why" in question.lower() or "join" in question.lower() or "team" in question.lower():
        return (
            "I want to join the team because of your focus on cutting-edge AI automation. "
            "With my background in Python and backend APIs, I am excited to help build scalable, "
            "autonomous job hunting solutions that deliver immediate value to users."
        )
    elif "experience" in question.lower() or "python" in question.lower() or "fastapi" in question.lower() or "async" in question.lower():
        return (
            "I have extensive experience building microservices with FastAPI and asynchronous Python. "
            "I regularly leverage asyncio for high-throughput tasks, integrate SQLite/PostgreSQL databases, "
            "and optimize background task workers for maximum reliability."
        )
    else:
        return "Based on my 5 years of Python experience, I am confident in my ability to contribute effectively, write clean, async-native code, and implement intelligent AI systems."
