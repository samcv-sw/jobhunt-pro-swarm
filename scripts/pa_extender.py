...
def extend_pythonanywhere():
    ...
    if not all([username, password, totp_secret]):
        print("❌ Error: Missing PA_USERNAME, PA_PASSWORD, or PA_TOTP_SECRET in environment variables.")
        return
        
    print(f"🔄 Starting auto-renewal process for PythonAnywhere user: {username}...")
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # 3. Webapps Dashboard
            print("🖥️ Navigating to Webapps dashboard...")
            ...
            print("⏳ Looking for the extend button...")
            try:
                ...
                if extend_btn:
                    extend_btn.click()
                    print("✅ Successfully clicked the extend button! Your server will not sleep.")
                else:
                    ...
                    if extend_btn_alt:
                        ...
                        print("⚠️ Could not find the extend button. It might already be extended to the maximum allowed date.")
